    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div
              className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 max-w-2xl w-full max-h-[80vh] overflow-y-auto"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-800 dark:text-blue-400">
                        Press <kbd className="px-2 py-0.5 text-xs font-semibold bg-white dark:bg-blue-800 border border-blue-300 dark:border-blue-600 rounded">?</kbd> anytime to view this panel.
                      </p>
                    </div>
                  </div>
                </div>
